      ...
      <div className="section-center featured-center">
        <article className="tour-card">
          <div className="tour-img-container">
            <img src={imagen1} className="tour-img" alt="" />
        ...
        <article className="tour-card">
          <div className="tour-img-container">
            <img src={imagen2} className="tour-img" alt="" />
        ...
        <article className="tour-card">
          <div className="tour-img-container">
            <img src={imagen3} className="tour-img" alt="" />
        ...
        <article className="tour-card">
          <div className="tour-img-container">
            <img src={imagen4} className="tour-img" alt="" />
